    ...
    if (rules.isSuccess) {
      ...
      if (page == 1) {
        ...
        ruleState.forEach((val) => {
          if (!tempObj[val.name]) tempObj[val.name] = val;
        });
        ...
        <Fragment>
          {ruleState.length == 0 ? (
            ...
            <Fragment>
              <div
                style={{
                  height: !props.fullScreenModeOpen ? "calc(100vh - 450px)" : '72vh',
                  minHeight: !props.fullScreenModeOpen ? "250px" : "100%",
                  overflowY: "scroll",
                }}
              >
                {
