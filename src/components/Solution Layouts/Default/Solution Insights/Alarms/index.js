...
export default function Alarms(props) {
  ...
  // function updateCount(payload, num) {
  //   setAlarmCounts((prev) => {
  //     let oldCount = { ...prev };
  //     oldCount[payload.severity] = oldCount[payload.severity] + num;
  //     return oldCount;
  //   });
  // }
        ...
        >
          {alarms[severity].length == 0 ? (
            ...
            <Fragment>
              <div
                style={{
                  height: !props.fullScreenModeOpen ?  "calc(100vh - 500px)":"72vh",
                  minHeight:!props.fullScreenModeOpen ?  "160px":'100%',
                  overflowY: "scroll",
                }}
              >
