...
export default function ControlledAccordions(props) {
  ...
  const schedules = useGetSchedulesGlobalQuery({
    token,
    params: `?serviceId=${props.id}&pageSize=10&currentPage=${page}&withTotalPages=true&groupId=${filtersValue.group.id}`,
  });
    ...
    >
      ...
      {chkGroup() == "ALL" ? (
        ...
        >
          ...
          >
            {/* Not required for Now, Needs sockets implementation*/}
            {/* <IconButton
              color="secondary"
              disabled={
