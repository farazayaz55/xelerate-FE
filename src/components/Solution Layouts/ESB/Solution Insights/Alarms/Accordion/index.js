...
import { setMetaData } from "rtkSlices/metaDataSlice";
...
export default function ControlledAccordions(props) {
  ...
  // temporary edit for showing accoprdion on defualt opened
  useEffect(() => {
      ...
      return (
        <Fragment>
          <span>
            ...
            <p>{`${text.sensorFriendlyName} (value: ${text.reading}) - is ${text.condition} - ${text.threshold}`}</p>
          </span>
          <span>
            <span
              style={{
            ...
            <p>
              Actuation triggered: {text.actuatorName} → {text.command}
            </p>
          </span>
        </Fragment>
      );
  ...
  return (
    ...
    >
      ...
      >
          ...
          >
            ...
            props.alarm.status == "ACKNOWLEDGED" ? (
              <Skeleton
                ...
                style={{
                  backgroundColor:
                    props.alarm.status == "ACKNOWLEDGED" ? "orange" : "#bf3535",
                  position: "relative",
                  top: "7px",
                }}
              />
        ...
        {props.alarm.generatedBy == "Invixible" ? (
          <div
            style={{
              display: "flex",
              gap: "10px",
            ...
            >
              ...
              <div style={{ marginTop: "3px" }}>
                ...
                <Typography variant="caption">
                  <strong>{`${time.toLocaleDateString()} - ${time.toLocaleTimeString()}`}</strong>
                </Typography>
              </div>
            </div>
          </span>
