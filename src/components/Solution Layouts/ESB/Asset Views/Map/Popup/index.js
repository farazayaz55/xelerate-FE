                ...
                >
                  <img
                    ...
                    src={
                      !data?.esbDeviceType
                        ? service.assets.find(
                            (asset) => asset.id == data.platformDeviceType
                          )
                          ? service.assets.find(
                              (asset) => asset.id == data.platformDeviceType
                            ).image
                          : Other
                        : data.esbDeviceType == "EVCharger"
                        ? EVCharger
                        : data.esbDeviceType == "Inverter"
                        ? Inverter
                        : Other
                    }
                    style={{
                        ...
                        >
                          <div
                            style={{
                              ...
                              justifyContent: "space-between",
                              gap:
                                measurements && measurements[elm.name]?.unit
                                  ? "3px"
                                  : "0",
                              color: getTextColor(
