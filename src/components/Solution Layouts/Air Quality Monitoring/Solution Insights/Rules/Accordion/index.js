      ...
      <AccordionDetails>
        ...
        >
          <span style={{ width: "100%" }}>
            ...
            >
            <Tooltip title={props.rule.multipleOperations &&
                props.rule.multipleOperations.length > 1 ? props.rule.multipleOperations.map(val => {
                  return(
                    <p>
                    {getFriendlyName(
                      val.parameter
              ...
              {props.rule.multipleOperations &&
                props.rule.multipleOperations.length > 1 ? (
                  <>
                    ...
                    >
                      <b>
                      {props.rule.multipleOperations.length + " " + props.rule.multipleOperationsOperator + " Conditions - "}
                      </b>
                    </p>
                  </>
                ) : null}
